...
- Or right-click in the project folder (repository root) and select "Open in Terminal"

### 2. Navigate to the Project Folder

```bash
cd path\to\Claimwise-handoff
```
(Use the folder where this repo’s `package.json` lives.)
